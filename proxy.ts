...
export const config = {
  // Excludes: _next internals, /api, /admin (its own root layout, outside
  // [locale] — see app/admin/layout.tsx), anything with a file extension
  ...
  // /es/icon and 404.
  matcher: [
    "/((?!_next|api|admin(?:$|/)|icon(?:$|/)|apple-icon(?:$|/)|opengraph-image(?:$|/)|twitter-image(?:$|/)|.*\\..*).*)",
  ],
};
